...
---
Diagnostics only:
  python -m gedcom_parser.postprocess.place_plan_applier -i outputs/export_c24_7.json -o outputs/export_c24_9.json

Apply plan:
  python -m gedcom_parser.postprocess.place_plan_applier -i outputs/export_c24_7.json -p merge_plan.json -o outputs/export_c24_9.json
